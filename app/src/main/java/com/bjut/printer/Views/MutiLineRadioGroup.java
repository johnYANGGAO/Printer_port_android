...
public class MutiLineRadioGroup extends LinearLayout {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    if (mOnCheckedChangeListener != null) {
                        mOnCheckedChangeListener.onCheckedChanged(
                                MutiLineRadioGroup.this, child.getId());
                    }
                    return true;
                }
            });
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(MutiLineRadioGroup.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.setClassName(MutiLineRadioGroup.class.getName());
    }
    ...
    public interface OnCheckedChangeListener {
        ...
        public void onCheckedChanged(MutiLineRadioGroup group, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == MutiLineRadioGroup.this
